...
public:
	...
	// mouse scroll callback that influences the movement speed of the camera movement dictated by the keyboard keyss
	static void Mouse_Scroll_MovementSpeed_Callback(GLFWwindow* window, double xOffset, double yOffset);
